...
5. Configure your deployment
    ...
    Also, make sure the update the `values.yaml` file for appropriate verions of the docker image you want to use for ingress, ui, engine and asset catalog applications. Go [here](https://github.com/orgs/SoftwareAG/packages?repo_name=webmethods-api-control-plane) so see what's available.
