...
4. Configure your deployment
    ...
    Also, make sure the update the `.env` file for appropriate verions of the docker image you want to use for INGRESS_IMAGE, UI_IMAGE, ENGINE_IMAGE and ASSETCATALOG_IMAGE deployments. Go [here](https://github.com/orgs/SoftwareAG/packages?repo_name=webmethods-api-control-plane) so see what's available.
